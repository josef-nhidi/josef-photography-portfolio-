...
const Events = ({ settings }) => {
  return (
    <PortfolioLayout
      ...
      seoKeywords="professional event photography, cinematic wedding photographer, corporate event coverage, documentary photography, Josef Nhidi, photographer Tunisia, professional photography services"
      url="/events"
    />
  );
};
